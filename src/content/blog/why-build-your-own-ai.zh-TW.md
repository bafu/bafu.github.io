...
以下 Omni 開發日記全部都基於真實的開發時間軸，包含花了多少個 commit 、走過的冤枉路、建了又拆的錯誤決策、以及過程中的技術與商業考量，全部都是真實的。

我認為 "公司的主權 AI" 絕對是未來五年的重要趨勢，沒有 AI 的公司已知會落後競爭對手，而沒有主權 AI 的公司還是會落後競爭對手，因為你的生命線掌握在 AI 公司手上，而不是自己公司。

建立主權 AI 已經很難了，建立一個好用、讓跟全公司不同部門需求都相容的 AI 更難，不是兜幾個開源專案就可以，要考慮的事情很多，不同公司的考量也會有所不同。

在開發 Omni 的過程中我曾經走錯路、也做過很多錯誤的決策，還有 "founder 腦的商業思維 v.s. 工程腦的技術考量" 不斷拉鋸，希望透過公開這個開發日記，讓這些思路過程與走過的冤枉路，能帶給正在建立自己、或者公司主權 AI 的你一些幫助。
...
更近的例子：2026 年 4 月 4 日，Anthropic 宣布禁止 Claude 訂閱用戶透過 OpenClaw 等第三方代理框架使用其服務。想像一下——你的團隊花了兩個月、好不容易建好了 OpenClaw + Claude 的代理人系統，正準備上線，然後一則公告，一切努力付諸流水。這就是把核心工作流程建立在你無法控制的平台上的風險。
